        ...
        <div class="py-3 col-span-1 px-4 bg-white">
            <form action="{{route('updateGroup', $memberGroup->id)}}" method="POST">
                ...
                <div class="w-full px-3">
                    <input name="groupname" value="{{$memberGroup->name}}" class="font-normal text-xs appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="@lang('group.groupname')">
