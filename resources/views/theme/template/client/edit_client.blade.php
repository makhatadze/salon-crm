            ...
            <div class="flex">
               ...
               <div class="flex">
                <div class="w-1/2 p-2">
                    ...
                    <input type="text" min="0" step="1" name="client_address" id="client_address" value="{{$client->address}}" class="font-normal text-sm input w-full border mt-2" placeholder="კლიენტის მისამართი">
                </div>
                <div class="w-1/2 p-2">
                    <label class="font-bold font-caps text-xs text-gray-700">ნომერი <span class="text-red-500">*</span></label>
                <input required type="text" min="0" step="1" name="client_number" value="{{$client->number}}" id="client_number" class="font-normal text-sm input w-full border mt-2" placeholder="კლიენტის ნომერი">
                </div>
               </div>
               ...
               <div class="flex relative" @if(!$serv->status) id="rem{{$serv->id}}" @endif>
                @if(!$serv->status)
                ...
                <div class="w-1/4 p-2">
                        ...
                        <div class="w-1/4 p-2">
                            ...
                            <div class="w-full mt-2">
                                <input  @if($serv->status) disabled @endif required value="{{Carbon\Carbon::parse($serv->session_start_time)->format('Y-m-d')}}"  type="date" class=" input w-full border block mx-auto"> 
                            </div>
