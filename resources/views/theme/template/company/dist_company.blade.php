                ...
                <div class="bg-gray-200 p-4 rounded-md">
                    <div  class="mb-2 flex justify-between items-center">
                            ...
                            <div x-data="{modal: false}">
                                <button @click="modal = true" class="p-2 bg-white rounded">
                                ...
                                <x-modal x-show="modal">
                                    <form action="{{ route('smsSendPost') }}" method="POST" class="bg-white mx-auto" autocomplete="off">
                                        ...
                                        <input name="phone" value="{{$company->phone}}" readonly required class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" onkeyup="this.value = this.value.replace(/[^0-9\.]/g, '');" id="phone" type="text" minlength="9" maxlength="9" placeholder="555 11 22 33">
