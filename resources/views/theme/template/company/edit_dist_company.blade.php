...
<div class="intro-y col-span-6 box p-4">
    ...
    <form action="{{route('UpdateDistCompany', $distribution->id)}}" method="post">
        ...
        <input required type="text" class="input w-full border mt-2" value="{{$distribution->code}}"  name="code">
        </div>
        <div class="flex">
            <div class="w-1/3 p-2">
                <label class="font-helvetica">სახელი ქართულად<span class="text-red-700">*</span></label>
            <input required type="text" class="input w-full border mt-2" value="{{$distribution->name_ge}}"  name="name_ge">
            </div>
            
            <div class="w-1/3 p-2">
                <label class="font-helvetica">სახელი რუსულად</label>
                <input  type="text"  class="input w-full border mt-2" value="{{$distribution->name_ru}}" name="name_ru">
            </div>
            <div class="w-1/3 p-2">
                <label class="font-helvetica">სახელი ინგლისურად</label>
            <input  type="text"  class="input w-full border mt-2" name="name_en" value="{{$distribution->name_en}}">
            </div>
        </div>
