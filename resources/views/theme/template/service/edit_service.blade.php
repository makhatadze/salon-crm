        ...
        <div class="intro-y box p-5">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/3 p-2">
                    <label class="font-bold font-caps text-xs text-gray-700">@lang('service.title')</label>
                    <input type="text" required  name="title_ge" value="{{$service->title_ge}}"  class="font-normal text-xs mt-2 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" placeholder="xxxxxxxxxxxxx">
                      @error('title-ge')
                ...
                <div class="w-full md:w-1/3 flex">
                    <div class="w-full md:w-1/2 p-2">
                        <label class="font-bold font-caps text-xs text-gray-700">@lang('service.hour')</label>
                    ...
                    <div class="w-full md:w-1/2 p-2">
                        <label class="font-bold font-caps text-xs text-gray-700">@lang('service.minute')</label>
                ...
                <div class="w-full md:w-1/3 p-2">
                        <label for="price" class="block  leading-5 font-medium text-gray-700 font-bold font-caps text-xs">@lang('service.price')</label>
                        <div class="mt-2 relative rounded-md shadow-sm">
                          ...
                          <div class="absolute inset-y-0 right-0 flex items-center">
                            <select name="currency" aria-label="Currency" class="form-select h-full py-0 pl-2 pr-7 border-transparent bg-transparent text-gray-500 sm:text-sm sm:leading-5">
                              <option value="gel" @if($service->currency_type == "gel") selected @endif>@lang('money.slug')</option>
                            </select>
                          </div>
                        </div>
                      </div>
            ...
            @enderror
              ...
              <div>
                <div class="w-full p-2">
                     <label class="font-bold font-caps text-xs text-gray-700">@lang('service.image')</label>
                    ...
                    <div class="px-4 pb-2 flex items-center cursor-pointer relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image w-4 h-4 mr-2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg> <span class="text-theme-1 mr-1 font-bold font-caps text-xs ">@lang('service.uploadfile')</span> 
              ...
              <div class="my-4 flex justify-between items-center">
                <span class="font-medium text-base text-gray-700">@lang('service.inventorycat')</span>
            ...
            <div id="inventory" class="grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2  gap-3">
            @foreach ($service->inventories()->get() as $key => $inv)
                <div class="p-2 col-span-1" id="remove{{$inv->id}}">
                    <div class="bg-white shadow relative p-2">
                        <span class="text-white px-2 cursor-pointer rounded font-bold right-0 top-0 absolute bg-red-500" onclick="removeinventoryajax('{{$inv->id}}')" style="font-size: 0.7rem">@lang('service.delete')</span>
                        ...
                        <div class="relative">
                            ...
                            <option value="">@lang('service.choose')</option>
            ...
            @endforeach
              ...
              <div class="mt-2">
                  <label class="font-bold font-caps text-xs text-gray-700">@lang('service.desc')</label>
              ...
              @enderror
                 ...
                 <input type="submit" class=" button text-white bg-theme-1 shadow-md mr-1 mt-2 font-bold text-xs font-caps" value="@lang('service.add')">
            </form>
        </div>
