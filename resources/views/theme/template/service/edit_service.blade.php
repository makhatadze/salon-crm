        ...
        <div class="intro-y box p-5">
                <div class="flex">
                   ...
                   <div class="flex">
                       ...
                       <input required type="number" min="0" step="1" name="duration_count" value="{{$service->duration_count}}" id="duration_count" class="font-normal text-sm input w-full border mt-2" placeholder="მიუთითეთ დრო">
                       </div>
                    <div class="w-1/2 p-2">
