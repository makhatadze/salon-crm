        ...
        <div class="intro-y box p-5">
            ...
            <div class="flex">
                <div class="w-1/2 p-2">
                    ...
                    <input type="text" required  name="title_ge"  class="font-normal text-xs mt-2 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" placeholder="xxxxxxxxxxxxx">
                    @error('title-ge')
                ...
                <div class="w-full md:w-1/4 p-2">
                        ...
                        <div class="mt-2 relative rounded-md shadow-sm">
                          <input required autocomplete="off" type="number"  name="price" min="0" step="0.01" class="block font-medium border-gray-300 text-xs appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="xxx.xx">
                          <div class="absolute inset-y-0 right-0 flex items-center">
                            <select name="currency" aria-label="Currency" class="form-select h-full py-0 pl-2 pr-7 border-transparent bg-transparent text-gray-500 sm:text-sm sm:leading-5">
                              <option value="gel" selected>@lang('money.slug')</option>
                            </select>
                          </div>
                        </div>
                        @error('price')
            ...
            <div id="inventory" class="grid grid-cols-4 gap-3">
              ...
              @enderror
                ...
                <input type="submit" class=" button text-white bg-theme-1 font-bolder text-xs font-caps shadow-md mr-1" value="@lang('service.add')">
            </form>
        </div>
