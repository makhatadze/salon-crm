...
<div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <table class="table table-report -mt-2 col-span-12">
        ...
        <tbody>
           ...
           <td class="text-center font-normal font-caps">{{$serv->price/100}} 
            @if ($serv->currency_type == 'gel')
            ₾
            @elseif($serv->currency_type == 'usd')
            $
            @elseif($serv->currency_type == 'eur')
            €
            @endif</td>
               ...
               <td class="table-report__action w-56">
                   <div class="flex justify-center items-center font-bold">
                    <a href="/services/export/{{$serv->id}}" class="p-2 bg-gray-300 rounded-lg ml-2">
