        ...
        <thead>
            <tr>
                <th class="whitespace-no-wrap font-bold font-caps text-gray-700 text-xs">
					<input type="date" class="p-2 bg-transparent focus:outline-none focus:border-none" onchange="getdate(`'`+this.value+`'`)" value="<?php echo date('Y-m-d');?>"></th>
		  ...
		  <tr class="intro-x">
			...
			<td class="text-center whitespace-no-wrap">
				...
				<a href="/clients/turnon/{{$service->id}}" class="bg-gray-300 p-2 rounded-lg mr-2">
					...
					@endif
				<a href="/clients/edit/{{$service->clinetserviceable()->first()->id}}" class="bg-gray-300 p-2 rounded-lg mr-2">
