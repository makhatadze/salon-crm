                ...
                <div class="box p-5">
                    <div class="flex justify-between">
                        <div>
                            ...
                            <div class="text-3xl font-bold leading-8 mt-6">{{number_format($totalproductcost,2)}}<sup class="text-sm">@lang('money.icon')</sup></div>
                        </div>
                        <div>
                            <h6 class="text-gray-600 font-normal mt-1 text-xs">@lang('homepage.sold_product')</h6>
                            <div class="relative mt-2">
                                <select wire:model="totalproductcostget" class="font-normal text-xs block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                    <option>@lang('homepage.all')</option>
                                    <option value="today">@lang('homepage.today')</option>
                                    <option value="month">@lang('homepage.this_month')</option>
                                </select>
                ...
                <div class="box p-5">
                    <div class="flex justify-between">
                        <div>
                            ...
                            <div class="text-3xl font-bold leading-8 mt-6">{{number_format($soldservices,2)}}<sup class="text-sm">@lang('money.icon')</sup></div>
                        </div>
                        <div>
                            <h6 class="text-gray-600 font-normal mt-1 text-xs">@lang('homepage.sold_services')</h6>
                            <div class="relative mt-2">
                ...
                <div class="box p-5">
                    <div class="flex justify-between">
                        <div>
                            ...
                            <div class="text-3xl font-bold leading-8 mt-6">{{number_format($totalsalary/100, 2)}}<sup class="text-sm">@lang('money.icon')</sup></div>
                        </div>
                        <div>
                            <h6 class="text-gray-600 font-normal mt-1 text-xs">@lang('homepage.earn_money')</h6>
                            <div class="relative mt-2">
            ...
            <div class="report-box zoom-in">
                <div class="box p-5">
                    <div class="flex justify-between">
                        ...
                        <div>
                            <h6 class="text-gray-600 font-normal mt-1 text-xs">@lang('homepage.total_clients')</h6>
                            <div class="relative mt-2">
