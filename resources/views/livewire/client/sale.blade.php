<div>
    <h6 class="w-full font-bold mb-2 font-caps text-xs">გაყიდვები  <small class="font-normal ml-1">( {{$client->sales()->count()}} )</small></h6>
    <div class="p-2 bg-gray-200 flex items-center justify-center">
        ...
        <label for="consignation" class="font-normal text-xs ml-2">კონსიგნაცია</label>
    </div>
    @if ($sales)
