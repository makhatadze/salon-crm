<div>
    <div class="grid grid-cols-4 mt-3">
        <div class="col-span-1 px-4">
            <div class="bg-white p-3">
                <div class="flex items-center justify-between">
                    <a target="_blank" href="/purchases" class="font-bolder font-caps text-xs" style="color: #173858">შესყიდვები</a>
                    ...
                    <div class="relative ">
                        <select wire:model="purchasetime" class="block bg-gray-200 w-24 p-2 font-normal text-xs appearance-none pr-8 focus:outline-none" id="grid-state">
                          <option>სულ</option>
                          <option value="month">თვის</option>
                          <option value="today">დღის</option>
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 py-3 gap-4">
                    <div class="col-span-1 flex items-center">
                        ...
                        <div class="ml-2">
                            <span class="font-normal text-xs text-gray-600">ჯამში</span>
                    ...
                    <div class="col-span-1 flex items-center">
                        ...
                        <div class="ml-2">
                            <span class="font-normal text-xs text-gray-600">დავალიანება</span>
        ...
        <div class="col-span-1 px-4">
            <div class="bg-white p-3">
                <div class="flex items-center justify-between">
                    <a target="_blank" href="/products" class="font-bolder font-caps text-xs" style="color: #173858">პროდუქტები</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 py-3 gap-4">
                    ...
                    <div class="col-span-1 flex items-center">
                        <img src="{{asset('../img/warning.svg')}}" class="w-6 h-6 object-contain">
                        <div class="ml-2">
                            <span class="font-normal text-xs text-gray-600">გაყიდული</span>
        ...
        <div class="col-span-1 px-4">
            <div class="bg-white p-3">
                <div class="flex items-center justify-between">
                    <a target="_blank" href="/clients" class="font-bolder font-caps text-xs" style="color: #173858">სერვისი</a>
        ...
        <div class="col-span-1 px-4">
            <div class="bg-white p-3">
                <div class="flex items-center justify-between">
                    <a target="_blank" href="/clients" class="font-bolder font-caps text-xs" style="color: #173858">კლიენტები</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 py-3 gap-4">
                    <div class="col-span-1 flex items-center">
                        <img src="{{asset('../img/cheked.svg')}}" class="w-6 h-6 object-contain">
                        <div class="ml-2">
                            <span class="font-normal text-xs text-gray-600">გადახდილი</span>
