    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div
                ...
                <form method="POST" class="mt-5 intro-x" action="{{ route('password.email') }}">
                @csrf
                <input id="email" type="email" class="intro-x login__input input input--lg border border-gray-300 block mt-2" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
